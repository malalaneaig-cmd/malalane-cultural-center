...
const socialLinks = [
  ...
  },
  {
    ...
    href: 'https://www.linkedin.com/company/malalane-cultural-center',
  },
  {
    name: 'Facebook',
    icon: () => (
    ...
    href: 'https://www.facebook.com/malalaneculturalcenter',
  },
  {
    name: 'Instagram',
    icon: () => (
    ...
    href: 'https://www.instagram.com/malalanecultural',
  },
  {
    name: 'TikTok',
    icon: () => (
    ...
    href: 'https://www.tiktok.com/@malalanecc',
  },
  {
    name: 'Email',
    icon: () => (
